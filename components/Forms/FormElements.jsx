...
export const Select = (field) => {
  ...
  return (
    <div className="form-group row"> {/* pass in passContent here maybe? */}
      <label className="col-xs-2 col-form-label" >Action</label>
...
export const Input = (field) => {
  ...
  return (
    <div className="form-group row">
      <label className="col-xs-2 col-form-label" htmlFor={field.input.name}>
        {field.labelText}
      </label>
      <div className="col-xs-10">
...
export const Checkbox = (field) => {
  ...
  return (
    <div className="form-group row">
      <label className="col-xs-2" htmlFor={field.input.name}></label>
      <div className="col-xs-10">
